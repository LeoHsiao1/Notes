...
alter user 'root'@'localhost' identified by '******';   -- 修改用户的密码
update mysql.user set authentication_string=password('******') where user='root' and host='localhost';   -- 直接修改 mysql.user 表
