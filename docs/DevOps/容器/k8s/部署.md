  ...
  rancher_kubernetes_engine_config:
    ...
    services:                                   # 配置各个 k8s 组件
      ...
      kubelet:
        ...
        extra_args:
          max-pods: 110                         # 该节点上最多允许部署的 Pod 数

          eviction-hard: "memory.available<5%,nodefs.available<5%,imagefs.available<5%,nodefs.inodesFree<5%"  # 硬驱逐阈值
          # eviction-soft: "memory.available<10%,nodefs.available<10%"  # 软驱逐阈值
          ...
          # node-status-update-frequency: 10s     # 每隔多久 kubelet 上报 node 状态到 master node
